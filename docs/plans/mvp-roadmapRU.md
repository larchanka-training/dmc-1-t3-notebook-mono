...
- backend-функциональность продукта пока в основном скелетная
- auth, хранение notebook, выполнение кода, синхронизация и AI ещё не завершены как сквозные продуктовые возможности
...
- основу для хранения auth-данных и сессий
- запрос OTP по email
- проверку OTP и создание сессии
- восстановление сессии и выход
- сценарий Google OAuth
- доводку и стабилизацию интеграции auth
...
| 2 | Backend-авторизация и подключение реального входа | Реальный auth-сценарий | 0 | 1, 3 |
| 3 | Backend-хранение notebook | Долговременное хранение notebook | 0 | 1, 2 |
...
3. завершить этап 2 по backend-авторизации
...
- [ ] После этапов 0-1: каркас продукта и структура планирования достаточно стабильны для параллельной feature-разработки.
